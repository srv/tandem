...
class SectionRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SectionRequest
    // Serialize message field [initial_x]
    bufferOffset = _serializer.float64(obj.initial_x, buffer, bufferOffset);
    // Serialize message field [initial_y]
    bufferOffset = _serializer.float64(obj.initial_y, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SectionRequest
    let len;
    let data = new SectionRequest(null);
    // Deserialize message field [initial_x]
    data.initial_x = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [initial_y]
    data.initial_y = _deserializer.float64(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SectionRequest(null);
...
class SectionResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SectionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SectionResponse
    let len;
    let data = new SectionResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SectionResponse(null);
...
module.exports = {
  ...
  md5sum() { return '1f01abdb45291baeca36841eeb98714f'; },
  datatype() { return 'cola2_msgs/Section'; }
};
