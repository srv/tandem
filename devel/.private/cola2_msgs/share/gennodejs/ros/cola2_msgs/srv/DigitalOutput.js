...
class DigitalOutputRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DigitalOutputRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DigitalOutputRequest
    let len;
    let data = new DigitalOutputRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DigitalOutputRequest(null);
...
class DigitalOutputResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DigitalOutputResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DigitalOutputResponse
    let len;
    let data = new DigitalOutputResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DigitalOutputResponse(null);
...
module.exports = {
  ...
  Response: DigitalOutputResponse,
  md5sum() { return '183c2e45b1ebafc9b5e338f77154c8b4'; },
  datatype() { return 'cola2_msgs/DigitalOutput'; }
};
