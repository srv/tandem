...
class Setpoints {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float64(obj.setpoints, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Setpoints(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [setpoints]
    data.setpoints = _arrayDeserializer.float64(buffer, bufferOffset, null)
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 8 * object.setpoints.length;
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Setpoints(null);
