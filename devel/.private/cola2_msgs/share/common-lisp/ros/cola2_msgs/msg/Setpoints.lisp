...
(cl:defmethod cl:initialize-instance :after ((m <Setpoints>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Setpoints)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cola2_msgs-msg:<Setpoints> is deprecated: use cola2_msgs-msg:Setpoints instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Setpoints>))
...
(cl:defmethod setpoints-val ((m <Setpoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cola2_msgs-msg:setpoints-val is deprecated.  Use cola2_msgs-msg:setpoints instead.")
  (setpoints m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Setpoints>)))
  ...
  "d13a8e7b230df87e00dd540874a14b59")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Setpoints)))
  "Returns md5sum for a message object of type 'Setpoints"
  "d13a8e7b230df87e00dd540874a14b59")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Setpoints>)))
  ...
  (cl:format cl:nil "Header header~%float64[] setpoints~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Setpoints)))
  "Returns full string definition for message of type 'Setpoints"
  (cl:format cl:nil "Header header~%float64[] setpoints~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Setpoints>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'setpoints) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
))
