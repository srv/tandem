...
(cl:defmethod cl:initialize-instance :after ((m <DVLBeam>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DVLBeam)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cola2_msgs-msg:<DVLBeam> is deprecated: use cola2_msgs-msg:DVLBeam instead.")))
...
(cl:defmethod range_covariance-val ((m <DVLBeam>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cola2_msgs-msg:range_covariance-val is deprecated.  Use cola2_msgs-msg:range_covariance instead.")
  (range_covariance m))
...
(cl:defmethod pose-val ((m <DVLBeam>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cola2_msgs-msg:pose-val is deprecated.  Use cola2_msgs-msg:pose instead.")
  (pose m))
