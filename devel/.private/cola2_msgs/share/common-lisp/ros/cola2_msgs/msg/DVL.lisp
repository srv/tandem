...
(cl:defclass <DVL> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (beams
    :reader beams
    :initarg :beams
    :type (cl:vector cola2_msgs-msg:DVLBeam)
   :initform (cl:make-array 0 :element-type 'cola2_msgs-msg:DVLBeam :initial-element (cl:make-instance 'cola2_msgs-msg:DVLBeam))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DVL>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DVL)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cola2_msgs-msg:<DVL> is deprecated: use cola2_msgs-msg:DVL instead.")))
...
(cl:defmethod velocity-val ((m <DVL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cola2_msgs-msg:velocity-val is deprecated.  Use cola2_msgs-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'velocity_covariance-val :lambda-list '(m))
(cl:defmethod velocity_covariance-val ((m <DVL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cola2_msgs-msg:velocity_covariance-val is deprecated.  Use cola2_msgs-msg:velocity_covariance instead.")
...
(cl:defmethod beams-val ((m <DVL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cola2_msgs-msg:beams-val is deprecated.  Use cola2_msgs-msg:beams instead.")
  (beams m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DVL>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'beams)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'cola2_msgs-msg:DVLBeam))
