...
"""autogenerated by genpy from cola2_msgs/Bool6Axis.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_6B().pack(_x.x, _x.y, _x.z, _x.roll, _x.pitch, _x.yaw))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.x, _x.y, _x.z, _x.roll, _x.pitch, _x.yaw,) = _get_struct_6B().unpack(str[start:end])
      self.x = bool(self.x)
      self.y = bool(self.y)
      self.z = bool(self.z)
