...
"""autogenerated by genpy from cola2_msgs/PilotActionResult.msg. Do not edit."""
import codecs
import sys
...
class PilotActionResult(genpy.Message):
  _md5sum = "751922dccc45cef92b860a70ef9250b1"
  _type = "cola2_msgs/PilotActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cola2_msgs/PilotResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PilotActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cola2_msgs.msg.PilotResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cola2_msgs.msg.PilotResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.state,) = _get_struct_Q().unpack(str[start:end])
      return self
